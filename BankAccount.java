...
class SavAcc extends Account {
    ...
    void interest() {
        ...
        balance = balance + (balance * 0.10 * (month / 12));
...
class CurAcc extends Account {
    ...
    CurAcc(String customerName, int accountNumber, String typeOfAccount, double minBalance) {
        super(customerName, accountNumber, typeOfAccount);
...
class BankAccount {
    public static void main(String args[]) {
        ...
        System.out.print("Enter min balance to be maintained in CuurentAccount: ");
        double min = sc.nextDouble();
        CurAcc curr = new CurAcc(name, AccNo2, "CurrentAccount", min);//Creating CuurentAccount object
